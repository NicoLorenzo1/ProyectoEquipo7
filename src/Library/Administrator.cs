                    ...
                    if (!(UsersToPlay.ElementAt(x).Key == match1.Key))
                    {
                        if (UsersToPlay.ElementAt(x).Value == match1.Value)
                        {
                            ...
                            else if (match1.Value == "challenge")
                            {
                                ...
                                HitController counterHelper = new HitController(challenge);
                                challenge.StartGame();
                            }
                            else if (match1.Value == "bomb")
                            {
                                ...
                                HitController counterHelper = new HitController(bomb);
                                bomb.StartGame();
                            }
                            else if (match1.Value == "timetrial")
                            {
                                ...
                                HitController counterHelper = new HitController(timeTrial);
                                //timeTrial.StartGame();
                            }
                        }
                    }
